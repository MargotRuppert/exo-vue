<template>
    <div class="card bg-base-200 shadow-xl p-6 max-w-xl mx-auto">
        ...
        <button class="btn bg-primary-content" @click="ajout">Ajouter 50</button>
        <button class="btn bg-primary" @click="random">Randomize</button>
    </div>
</template>
...
function random(){
    dynamicData.value = Math.floor(Math.random() * 2000);
}
