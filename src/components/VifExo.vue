<template>
    <div class="container mx-auto p-4">
        <div class="card shadow-lg p-6 bg-base-100">
            ...
            <input v-model="film" type="text" placeholder="Entrez le nom d'un film" class="input input-bordered w-full mb-3" />

            <button @click="tabFilm.push(film)" class="btn btn-primary mb-4">
            ...
            <p class="text-gray-500" v-if="tabFilm.length" v-for="(film, index) in tabFilm" @click="tabFilm.splice(index, 1)">
                 {{`${index} ${film}` }}
            </p>
